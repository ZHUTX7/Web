...
<body>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="heading"><h2>修改广告信息</h2></div>
					<% request.setCharacterEncoding("utf-8");
					 int ad_id=Integer.parseInt(request.getParameter("ad_id"));
 						PublishAdvertisement ad=PublishAdDB.getAdById(ad_id);
 						
					   if(ad!=null){ %>
  						<form method="post"	 action="modifyAd"	>
		...
		enctype="multipart/form-data">
			...
			Input文件：&nbsp<input type="file" name="file"
				style="width: 160px;"><input  type="submit"  value="上传" />
						...
						<div class="form-group">
							<p>广告图跳转链接:<input type="text" name="ahref_url" value="<%=ad.getAhref_url() %>" class="form-control" required>
						</div>
						<div class="form-group">
