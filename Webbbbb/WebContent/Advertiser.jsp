...
<body>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="heading"><h2>广告方信息</h2></div>
					<% request.setCharacterEncoding("utf-8");
					Object us=session.getAttribute("user") ;
 						User user = (User)us;
 						
 						if(user!=null){
 						Company cm=CompanyDB.getCompanyById(user.getUser_id()); %>
  						<div class="form-group">
							<p>公司:<%=cm.getCompany_name() %>
						</div>
						<div class="form-group">
							<p>联系电话:<%=cm.getCompany_mobile() %>
						</div>
						<div class="form-group">
							<p>代理人:<%=user.getUser_name() %>
						</div>
				...
				<div class="col-md-6">
					<div class="heading"><h2>功能模块</h2></div>
						...
						<div class="form-group">
							<a href="AdvertiseManage.jsp" class="btn btn-2 ">广告管理</a>
						</div>
