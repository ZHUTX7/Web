...
<body>
	...
	<p><% 
			...
			Order o=OrderDB.getOrderId(order_id);
			
			
	%>		
	<p>买家昵称<%=UserDB.getUserById(o.getCustomer_id()).getUser_name() %>
	<p>卖家昵称<%=UserDB.getUserById(o.getSeller_id()).getUser_name() %>
	<p>收货人及收货地址<%=o.getCustomer_adress() %>
	<p>买家手机号<%=o.getCustomer_mobile() %>
	<p>商品名称：<%=o.getGoods_name() %>
	<p>价格：<%=o.getGoods_price() %>
	<p>交易时间：<%=o.getYear()%>年  <%=o.getMonth()%>月<%=o.getDay() %>日
	<p>
	<p>
	<p><a href="orderManage.jsp"  > ➡返回⬅</a>
	<hr>
