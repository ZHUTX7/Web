			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="#">申请成为广告方管理</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="heading"><h2>申请成为广告方</h2></div>
					
  						<form method="post"	 action="creatAdvertiser"	>
  						<input type="hidden" name="user_id" value="<%=user.getUser_id() %>">
  						
  						<div class="form-group">
							<p>公司名称:<input type="text" name="company_name"  class="form-control" required>
						</div>
						<div class="form-group">
							<p>联系电话:<input type="text" name="company_mobile"  class="form-control" required>
						</div>
						<div class="form-group">
							<input name="agree" id="agree" type="checkbox" value="1"  required> I agree    <a href="www.baidu.com" >《注意事项》</a>
						</div>
						<div class="form-group">
