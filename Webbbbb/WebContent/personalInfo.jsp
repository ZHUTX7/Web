	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			<div class="row">
					...
					Object us=session.getAttribute("user") ;
 						...
 						if(user!=null){%>
  						<div class="form-group">
							<p>昵称：<%=user.getUser_name() %>
						</div>
						<div class="form-group">
							<p>性别:<%=user.getUser_sex() %>
						</div>
						<div class="form-group">
							<p>手机号码:<%=user.getUser_mobile() %>
						</div>
						<div class="form-group">
							<p>Email:<%=user.getUser_email() %>
						</div>
						<div class="form-group">
							<p>收货地址:<%=user.getUser_adress() %>
						</div>
						<div class="form-group">
							<p>身份证号:**************
						</div>
				...
				<div class="col-md-6">
					<div class="heading"><h2>功能模块</h2></div>
						<div class="form-group">
							<a href="modifyInfo.jsp" class="btn btn-2 ">修改个人信息</a>
						
							<a href="modifyPassword.jsp" class="btn btn-2 ">修改密码</a>
						</div>
						<div class="form-group">
						<a href="UserGoods.jsp" class="btn btn-2 ">商品转让</a>
						
						<a href="UserRoom.jsp" class="btn btn-2 ">房屋出租</a>
						</div>
						<div class="form-group">
						<a href="orderManage.jsp" class="btn btn-2 ">物品交易订单</a>
						
						<a href="rentManage.jsp" class="btn btn-2 ">租房记录</a>
						</div>
						<div class="form-group">
						<a href="personalWish.jsp" class="btn btn-2 ">商品收藏夹</a>
						<% if(CompanyDB.getCompanyById(user.getUser_id())!=null) {%>
						<a href="Advertiser.jsp" class="btn btn-2 ">广告方</a>
						<%} else{%>
						<a href="creatAdvertiser.jsp" class="btn btn-2 ">成为广告方</a>
						<%} %>
						</div>
				</div>
			</div><!-- row -->
