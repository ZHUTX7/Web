...
<body>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<%  request.setCharacterEncoding("utf-8");
						...
						<p>请输入密码:<input type="text" class="form-control" placeholder="Password :" name="password1"  required>
						<input type="hidden" name="password"  value="<%=user.getUser_password() %>">
						<p>请输入新密码:<input type="password" class="form-control" placeholder="New Password :" name="new_password1"  required>
						<p>请再次输入新密码:<input type="password" class="form-control" placeholder="New Password :" name="new_password2"  required>	
						</div>
			...
			<div class="col-md-6">
			<div class="heading"><h2><%if(request.getParameter("result")!=null)
				out.print(request.getParameter("result"));%></h2></div>
